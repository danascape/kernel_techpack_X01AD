...
/* Huaqin modify for ZB632KL by qiaoxiaokun at 2018/10/31 start */
...
/* Huaqin modify for JD2019 by qiaoxiaokun at 2018/10/23 start*/
...
#endif
/* Huaqin modify for JD2019 by qiaoxiaokun at 2018/10/23 end*/
int focal_flag = 0;
...
FF_LOGE("request_threaded_irq befor.");
        /* Register IRQ. */
...
FF_LOGE("request_threaded_irq later.");
...
/* Huaqin modify for ZB632KL by qiaoxiaokun at 2018/10/31 end */
    ...
    /* Initialize the chip. */
#ifdef CHIP_TYPE_FT9304	 
    if (ff_ctl_init_driver() == 0 && ff_ctl_init_driver() != 0) {
	FF_LOGE("ff_ctl_init_driver,ff_ctl_init_driver= fail");        
	err = ff_ctl_free_driver();
        g_context->b_driver_inited = false;
    }
#endif
